...
echo $epoch
python3 -c"import functions; functions.checkBonus($epoch)"
bonus_list=$(cat tmp/tB.json)

echo ${bonus_list}


python3 -c"import processBonus; processBonus.processBonus($epoch, $bonus_list)"
