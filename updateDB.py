...
def updateOwnersData(y):
	...
	while k < lo :
		...
		o_GoneEpoch = 0; #ownerStrg[k]["gone_epoch"];
		...
		sqlOwnerPledge = "INSERT IGNORE INTO pledge (owner_stake_address, epoch_epoch_number, amount, sum, previous, diff, max, min, inputs_sum, outputs_sum, ROA_current, ROA_max) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)";
		valOwnerPledge =(o_Address, epoch, o_Stake_current, o_Stake_sum, o_Stake_previous, o_Stake_diff, o_Stake_max, o_Stake_min, o_Stake_inputs, o_Stake_outputs, o_ROA_current, o_ROA_max);
...
def updateDelegatorsData(y):
	...
	while j < ld :
		...
		sqlDelegatorStake = "INSERT IGNORE INTO stake (delegator_stake_address, epoch_epoch_number, amount, sum, previous, diff, max, min, inputs_sum, outputs_sum) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)";
		valDelegStake =(d_Address, epoch, d_Stake_current, d_Stake_sum, d_Stake_previous, d_Stake_diff, d_Stake_max, d_Stake_min, d_Stake_inputs, d_Stake_outputs);
		...
		if d_bonus_amount > 0 :
			...
			valBonus = (d_bonus_amount, d_bonus_sum, y, d_Address, d_bonus_amount, d_bonus_sum);
			...
			while a < l_Assets :
				...
				sqlAsset = "INSERT INTO assets (epoch_epoch_number, delegator_stake_address, name, amount, policyID, name_hash, fingerprint) VALUES (%s, %s, %s, %s, %s, %s, %s) ON DUPLICATE KEY UPDATE name = %s, amount = %s, policyID = %s, name_hash = %s"
				valAssetA = (y, d_Address, d_asset_name, d_asset_amount, d_asset_policy, d_asset_hashname, d_asset_fingerprint);
				valAssetB = (d_asset_name, d_asset_amount, d_asset_policy, d_asset_hashname);
